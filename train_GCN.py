...
# Training settings
from graphino.training import evaluate, train_epoch, get_dataloaders_atm, get_dataloaders_oc, get_dirs
...
(adj, static_feats, _), (trainloader, valloader, testloader) = get_dataloaders_oc(params, net_params)
