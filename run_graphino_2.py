...
# Training settings
from eval_gcn_2 import ensemble_performance
from graphino.training_2 import evaluate, train_epoch, get_dataloaders
...
if __name__ == '__main__':
    ...
    for i, config_file in enumerate(config_files):
        ...
        # Model and optimizer
        print(f"Starting model {config_file}") 
        ...
        save_model(model, ckpt_dir, params, net_params, optimizer, epoch, ID='last_2_model.pkl')
        writer.flush()
        writer.close()
